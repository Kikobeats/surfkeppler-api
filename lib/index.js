...
function createClient (opts) {
  ...
  client.sails = {
    ...
    offer: client.bind(client, {path: 'Windsurf-Sails'})
  }

  client.boards = {
    new: client.bind(client, {path: 'Boards'}),
    offer: client.bind(client, {path: 'Windsurf-Boards_1'})
  }

  client.booms = {
    offer: client.bind(client, {path: 'Booms'})
  }

  client.masts = {
    new: client.bind(client, {path: 'Masts'}),
    offer: client.bind(client, {path: 'Masten-Special_1'})
  }
